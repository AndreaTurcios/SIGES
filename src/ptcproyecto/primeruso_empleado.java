...
public class primeruso_empleado extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("PRIMER USO EMPLEADO");
        ...
        jLabel4.setText("Cargo del empleado:");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(primeruso_empleado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new primeruso_empleado().setVisible(true);
            }
        });
    }
