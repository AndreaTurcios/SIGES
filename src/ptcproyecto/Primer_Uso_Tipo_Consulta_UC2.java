...
public class Primer_Uso_Tipo_Consulta_UC2 extends javax.swing.JFrame {

    /**
     * Creates new form Primer_Uso_Tipo_Consulta_UC2
     */
    public Primer_Uso_Tipo_Consulta_UC2() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel4.setText("TIPO CONSULTA - PRIMER USO");
        jPanel1.add(jLabel4);
        ...
        jLabel1.setText("Nombre del encargado de registrar la consulta:");
        ...
        jPanel2.add(jLabel3);
        jLabel3.setBounds(20, 100, 350, 30);

        jLabel5.setFont(new java.awt.Font("Lucida Sans", 1, 14)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(244, 243, 238));
        jLabel5.setText("Bienvenido querido usuario, en esta ventana usted podra registrar el tipo de consultas");
        jPanel2.add(jLabel5);
        ...
        jLabel6.setText("Ingrese el nombre de la mascota (opcional):");
        ...
        jButton1.setBounds(150, 310, 170, 30);
        ...
        jButton2.setBounds(480, 300, 160, 30);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        Primer_Uso_Tipo_Cliente_UC1 llamar = new Primer_Uso_Tipo_Cliente_UC1();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Primer_Uso_Tipo_Consulta_UC2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Primer_Uso_Tipo_Consulta_UC2().setVisible(true);
            }
        });
    }
